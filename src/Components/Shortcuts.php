...
class Shortcuts extends Component
{
    ...
    public function __construct()
    {
        ...
        $this->link = config('admin.top_left_menu.dashboard.link');
        $this->btn_label = config('admin.top_left_menu.dashboard.btn_label');
        // 'https://source.unsplash.com/random/800x600'
        $this->items = [
            ['src' => 'https://source.unsplash.com/random/800x600', 'title' => 'Image 1' ],
            ['src' => 'https://source.unsplash.com/random/800x600', 'title' => 'Image 2' ],
        ];
