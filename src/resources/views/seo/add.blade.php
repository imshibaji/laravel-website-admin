    ...
    <div class="tab-content">
        ...
        <div class="tab-pane p-3" id="facebook" role="tabpanel">
            <p class="text-muted mb-0">
                ...
                <textarea id="meta-og-desc" class="form-control content" name="meta_og_description" placeholder="Meta Open Graph Description"></textarea>
        ...
        <div class="tab-pane p-3" id="twitter" role="tabpanel">
            <p class="text-muted mb-0">
                ...
                <input type="text" id="meta-twitter-keywords" class="form-control form-control-lg" name="meta_twitter_keywords" placeholder="Meta Twitter Keywords">
                <input type="text" id="meta-twitter-description" class="form-control form-control-lg" name="meta_twitter_description" placeholder="Meta Twitter Description">
