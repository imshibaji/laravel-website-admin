...
<div class="card-body">
    <div class="col-md-12">
        <h4 class="mt-0 header-title">Seo Edit</h4>
    ...
    <div class="tab-content">
        <div class="tab-pane p-3 active" id="home-1" role="tabpanel">
            <input type="text" id="meta-url" class="form-control form-control-lg" name="url" placeholder="Meta Tag Url" value="{{ $seo->url }}">
            ...
            <textarea id="meta-description" class="form-control content" name="meta_description" placeholder="Meta Description">{{ $seo->meta_description }}</textarea>
        ...
        <div class="tab-pane p-3" id="facebook" role="tabpanel">
            <p class="text-muted mb-0">
                ...
                <textarea id="meta-og-description" class="form-control content" name="meta_og_description" placeholder="Meta Open Graph Description">{{ $seo->meta_og_description }}</textarea>
