<x-admin-base title="SMS Setup" item2="All Setup" link2="{{route('admin.business')}}">
<div class="row">
    <div class="col-md-8">
        <div class="card">
            <div class="card-body">
    ...
    <div class="col-md-4">
        <form action="{{ route('admin.business.setup.sms.post') }}" method="POST">
            @csrf
        <div class="card">
            <div class="card-header">
                <h5>SMS Gateway Setup</h5>
            </div>
            <div class="card-body">
                <div class="form-row">
