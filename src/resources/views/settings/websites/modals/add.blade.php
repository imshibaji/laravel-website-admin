<x-admin-modal btnname="Add Setting" size="md" type="secondary" title="General" action="{{ route('admin.websites.store') }}" method="POST">
    ...
    <div class="form-row">
        ...
        <x-admin-input name="Website Logo" type="file" fname="logo" placeholder="Input A Webapp Logo" />
    </div>
    <x-slot name="footer">
